...
export function FreeShip() {
  ...
  return (
    <div className="">
      <h3 className="text-gray-800 font-semibold mb-4 text-left">Free ship</h3>
      <div className="flex justify-between">
        <div className="text-left">Display on items with free shipping</div>
        <div>
          <button
